...
export async function up({ db, payload: _payload, req: _req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_role" AS ENUM('reader', 'contributor', 'reviewer', 'language_expert', 'moderator', 'admin');
  ...
  ALTER TABLE "contexts" ADD CONSTRAINT "contexts_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "contexts_slug_idx" ON "contexts" USING btree ("slug");
  CREATE INDEX "contexts_category_idx" ON "contexts" USING btree ("category_id");
